...
| [0005](0005-stale-gitignored-build-outputs-misreport-as-runtime-failures.md) | Deleting `node_modules` left gitignored build outputs stale, and every failure misreported as a runtime bug |
