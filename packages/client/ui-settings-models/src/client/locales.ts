...
export const en = {
  ...
  modalityText: 'Text',
  modalityImage: 'Image',
  modalityHint: 'Image is off unless the model accepts it.',
  modalityInvalid: 'Input modalities may only be text and image.',
  addModel: 'Add model',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modalityText: '文本',
  modalityImage: '图像',
  modalityHint: '除非模型支持，否则不启用图像。',
  modalityInvalid: '输入模态只能是文本或图像。',
  addModel: '添加模型',
  removeModel: '删除模型',
